### This is a study project that represents a small shop, fetches data from the GraphQL endpoint and provides an interface to view and interact with this data.
### Used technologies:
